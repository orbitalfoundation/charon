...
///
/// notes
///		TODO events probably need to percolate to scene graph
///		TODO why not make the window in the state object? 
///		TODO there is some fps timing stuff here that may be useful https://github.com/gfx-rs/wgpu/blob/master/wgpu/examples/framework.rs
///
